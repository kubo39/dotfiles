...
#    PS1="、-=≡( ՞ਊ ՞) < ${debian_chroot:+($debian_chroot)}\u@\h:\w\$(__git_ps1) \$ "
    PS1="( ՞ਊ ՞) ${debian_chroot:+($debian_chroot)}:\w\$(__git_ps1) \$ "
fi
...
export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:$HOME/rust-nightly-x86_64-unknown-linux-gnu/lib/rustlib/x86_64-unknown-linux-gnu/lib/"
